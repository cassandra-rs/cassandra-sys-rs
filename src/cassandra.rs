...
pub const CASS_VERSION_MINOR: ::std::os::raw::c_uint = 8;
pub const CASS_VERSION_PATCH: ::std::os::raw::c_uint = 0;
...
extern "C" {
    ...
    pub fn cass_cluster_set_contact_points(
        cluster: *mut CassCluster, contact_points: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_cluster_set_contact_points_n(
        cluster: *mut CassCluster, contact_points: *const ::std::os::raw::c_char, contact_points_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_authenticator_callbacks(
        cluster: *mut CassCluster, exchange_callbacks: *const CassAuthenticatorCallbacks,
        cleanup_callback: CassAuthenticatorDataCleanupCallback, data: *mut ::std::os::raw::c_void,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_cluster_set_protocol_version(
        cluster: *mut CassCluster, protocol_version: ::std::os::raw::c_int
    ) -> CassError;
}
extern "C" {
    ...
    /// @return CASS_OK if successful, otherwise an error occurred.
    pub fn cass_cluster_set_use_beta_protocol_version(cluster: *mut CassCluster, enable: cass_bool_t) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_queue_size_event(
        cluster: *mut CassCluster, queue_size: ::std::os::raw::c_uint
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_cluster_set_core_connections_per_host(
        cluster: *mut CassCluster, num_connections: ::std::os::raw::c_uint
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_max_concurrent_requests_threshold(
        cluster: *mut CassCluster, num_requests: ::std::os::raw::c_uint
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    pub fn cass_cluster_set_write_bytes_high_water_mark(
        cluster: *mut CassCluster, num_bytes: ::std::os::raw::c_uint
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_credentials(
        cluster: *mut CassCluster, username: *const ::std::os::raw::c_char, password: *const ::std::os::raw::c_char
    );
}
extern "C" {
    ...
    pub fn cass_cluster_set_credentials_n(
        cluster: *mut CassCluster, username: *const ::std::os::raw::c_char, username_length: usize,
...
extern "C" {
    ...
    pub fn cass_cluster_set_load_balance_dc_aware(
        cluster: *mut CassCluster, local_dc: *const ::std::os::raw::c_char,
        used_hosts_per_remote_dc: ::std::os::raw::c_uint, allow_remote_dcs_for_local_cl: cass_bool_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_cluster_set_load_balance_dc_aware_n(
        cluster: *mut CassCluster, local_dc: *const ::std::os::raw::c_char, local_dc_length: usize,
        used_hosts_per_remote_dc: ::std::os::raw::c_uint, allow_remote_dcs_for_local_cl: cass_bool_t,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_latency_aware_routing_settings(
        cluster: *mut CassCluster, exclusion_threshold: cass_double_t, scale_ms: cass_uint64_t,
        retry_period_ms: cass_uint64_t, update_rate_ms: cass_uint64_t, min_measured: cass_uint64_t,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_whitelist_filtering_n(
        cluster: *mut CassCluster, hosts: *const ::std::os::raw::c_char, hosts_length: usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_whitelist_dc_filtering_n(
        cluster: *mut CassCluster, dcs: *const ::std::os::raw::c_char, dcs_length: usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_tcp_keepalive(
        cluster: *mut CassCluster, enabled: cass_bool_t, delay_secs: ::std::os::raw::c_uint
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_connection_heartbeat_interval(
        cluster: *mut CassCluster, interval_secs: ::std::os::raw::c_uint
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_cluster_set_constant_speculative_execution_policy(
        cluster: *mut CassCluster, constant_delay_ms: cass_int64_t, max_speculative_executions: ::std::os::raw::c_int
    ) -> CassError;
}
extern "C" {
    ...
    /// @param[in] cluster
    /// @return CASS_OK if successful, otherwise an error occurred
    pub fn cass_cluster_set_no_speculative_execution_policy(cluster: *mut CassCluster) -> CassError;
}
extern "C" {
    ...
    /// @param enabled
    /// @return CASS_OK if successful, otherwise an error occurred
    pub fn cass_cluster_set_prepare_on_all_hosts(cluster: *mut CassCluster, enabled: cass_bool_t) -> CassError;
}
extern "C" {
    ...
    /// @param enabled
    /// @return CASS_OK if successful, otherwise an error occurred
    pub fn cass_cluster_set_prepare_on_up_or_add_host(cluster: *mut CassCluster, enabled: cass_bool_t) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_session_connect_keyspace(
        session: *mut CassSession, cluster: *const CassCluster, keyspace: *const ::std::os::raw::c_char
    ) -> *mut CassFuture;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_session_prepare_n(
        session: *mut CassSession, query: *const ::std::os::raw::c_char, query_length: usize
    ) -> *mut CassFuture;
}
extern "C" {
    ...
    pub fn cass_session_prepare_from_existing(
        session: *mut CassSession, statement: *mut CassStatement
    ) -> *mut CassFuture;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_schema_meta_keyspace_by_name(
        schema_meta: *const CassSchemaMeta, keyspace: *const ::std::os::raw::c_char
...
extern "C" {
    ...
    pub fn cass_schema_meta_keyspace_by_name_n(
        schema_meta: *const CassSchemaMeta, keyspace: *const ::std::os::raw::c_char, keyspace_length: usize
    ) -> *const CassKeyspaceMeta;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_name(
        keyspace_meta: *const CassKeyspaceMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_table_by_name(
        keyspace_meta: *const CassKeyspaceMeta, table: *const ::std::os::raw::c_char
    ) -> *const CassTableMeta;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_table_by_name_n(
        keyspace_meta: *const CassKeyspaceMeta, table: *const ::std::os::raw::c_char, table_length: usize
    ) -> *const CassTableMeta;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_materialized_view_by_name(
        keyspace_meta: *const CassKeyspaceMeta, view: *const ::std::os::raw::c_char
...
extern "C" {
    ...
    pub fn cass_keyspace_meta_materialized_view_by_name_n(
        keyspace_meta: *const CassKeyspaceMeta, view: *const ::std::os::raw::c_char, view_length: usize
    ) -> *const CassMaterializedViewMeta;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_user_type_by_name(
        keyspace_meta: *const CassKeyspaceMeta, type_: *const ::std::os::raw::c_char
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_user_type_by_name_n(
        keyspace_meta: *const CassKeyspaceMeta, type_: *const ::std::os::raw::c_char, type_length: usize
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_keyspace_meta_function_by_name(
        keyspace_meta: *const CassKeyspaceMeta, name: *const ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn cass_keyspace_meta_function_by_name_n(
        keyspace_meta: *const CassKeyspaceMeta, name: *const ::std::os::raw::c_char, name_length: usize,
...
extern "C" {
    ...
    pub fn cass_table_meta_name(
        table_meta: *const CassTableMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
    ...
    pub fn cass_table_meta_column_by_name(
        table_meta: *const CassTableMeta, column: *const ::std::os::raw::c_char
...
extern "C" {
    ...
    pub fn cass_table_meta_column_by_name_n(
        table_meta: *const CassTableMeta, column: *const ::std::os::raw::c_char, column_length: usize
    ) -> *const CassColumnMeta;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_table_meta_index_by_name(
        table_meta: *const CassTableMeta, index: *const ::std::os::raw::c_char
    ) -> *const CassIndexMeta;
}
extern "C" {
    ...
    pub fn cass_table_meta_index_by_name_n(
        table_meta: *const CassTableMeta, index: *const ::std::os::raw::c_char, index_length: usize
    ) -> *const CassIndexMeta;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_table_meta_materialized_view_by_name(
        table_meta: *const CassTableMeta, view: *const ::std::os::raw::c_char
    ) -> *const CassMaterializedViewMeta;
}
extern "C" {
    ...
    pub fn cass_table_meta_materialized_view_by_name_n(
        table_meta: *const CassTableMeta, view: *const ::std::os::raw::c_char, view_length: usize
    ) -> *const CassMaterializedViewMeta;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_table_meta_materialized_view(
        table_meta: *const CassTableMeta, index: usize
    ) -> *const CassMaterializedViewMeta;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_table_meta_field_by_name(
        table_meta: *const CassTableMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_table_meta_field_by_name_n(
        table_meta: *const CassTableMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_materialized_view_meta_column_by_name(
        view_meta: *const CassMaterializedViewMeta, column: *const ::std::os::raw::c_char
    ) -> *const CassColumnMeta;
}
extern "C" {
    ...
    pub fn cass_materialized_view_meta_column_by_name_n(
        view_meta: *const CassMaterializedViewMeta, column: *const ::std::os::raw::c_char, column_length: usize
    ) -> *const CassColumnMeta;
}
extern "C" {
    ...
    pub fn cass_materialized_view_meta_name(
        view_meta: *const CassMaterializedViewMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_materialized_view_meta_column(
        view_meta: *const CassMaterializedViewMeta, index: usize
    ) -> *const CassColumnMeta;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_materialized_view_meta_field_by_name(
        view_meta: *const CassMaterializedViewMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_materialized_view_meta_field_by_name_n(
        view_meta: *const CassMaterializedViewMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_column_meta_name(
        column_meta: *const CassColumnMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_column_meta_field_by_name(
        column_meta: *const CassColumnMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_column_meta_field_by_name_n(
        column_meta: *const CassColumnMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_index_meta_name(
        index_meta: *const CassIndexMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_index_meta_target(
        index_meta: *const CassIndexMeta, target: *mut *const ::std::os::raw::c_char, target_length: *mut usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_index_meta_field_by_name(
        index_meta: *const CassIndexMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_index_meta_field_by_name_n(
        index_meta: *const CassIndexMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_function_meta_name(
        function_meta: *const CassFunctionMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
    ...
    pub fn cass_function_meta_full_name(
        function_meta: *const CassFunctionMeta, full_name: *mut *const ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn cass_function_meta_body(
        function_meta: *const CassFunctionMeta, body: *mut *const ::std::os::raw::c_char, body_length: *mut usize
    );
}
extern "C" {
    ...
    pub fn cass_function_meta_language(
        function_meta: *const CassFunctionMeta, language: *mut *const ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn cass_function_meta_argument(
        function_meta: *const CassFunctionMeta, index: usize, name: *mut *const ::std::os::raw::c_char,
        name_length: *mut usize, type_: *mut *const CassDataType,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_function_meta_argument_type_by_name(
        function_meta: *const CassFunctionMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_function_meta_argument_type_by_name_n(
        function_meta: *const CassFunctionMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassDataType;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_aggregate_meta_name(
        aggregate_meta: *const CassAggregateMeta, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    );
}
extern "C" {
    ...
    pub fn cass_aggregate_meta_full_name(
        aggregate_meta: *const CassAggregateMeta, full_name: *mut *const ::std::os::raw::c_char,
        full_name_length: *mut usize,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_aggregate_meta_argument_type(
        aggregate_meta: *const CassAggregateMeta, index: usize
    ) -> *const CassDataType;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_aggregate_meta_field_by_name(
        aggregate_meta: *const CassAggregateMeta, name: *const ::std::os::raw::c_char
    ) -> *const CassValue;
}
extern "C" {
    ...
    pub fn cass_aggregate_meta_field_by_name_n(
        aggregate_meta: *const CassAggregateMeta, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_ssl_add_trusted_cert_n(
        ssl: *mut CassSsl, cert: *const ::std::os::raw::c_char, cert_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_ssl_set_private_key(
        ssl: *mut CassSsl, key: *const ::std::os::raw::c_char, password: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_ssl_set_private_key_n(
        ssl: *mut CassSsl, key: *const ::std::os::raw::c_char, key_length: usize,
        password: *const ::std::os::raw::c_char, password_length: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_authenticator_hostname(
        auth: *const CassAuthenticator, length: *mut usize
...
extern "C" {
    ...
    pub fn cass_authenticator_set_exchange_data(
        auth: *mut CassAuthenticator, exchange_data: *mut ::std::os::raw::c_void
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_authenticator_set_response(
        auth: *mut CassAuthenticator, response: *const ::std::os::raw::c_char, response_size: usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_authenticator_set_error_n(
        auth: *mut CassAuthenticator, message: *const ::std::os::raw::c_char, message_length: usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_future_set_callback(
        future: *mut CassFuture, callback: CassFutureCallback, data: *mut ::std::os::raw::c_void
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_future_error_message(
        future: *mut CassFuture, message: *mut *const ::std::os::raw::c_char, message_length: *mut usize
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_future_custom_payload_item(
        future: *mut CassFuture, index: usize, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize,
...
extern "C" {
    ...
    pub fn cass_statement_new_n(
        query: *const ::std::os::raw::c_char, query_length: usize, parameter_count: usize
    ) -> *mut CassStatement;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_set_keyspace(
        statement: *mut CassStatement, keyspace: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_set_keyspace_n(
        statement: *mut CassStatement, keyspace: *const ::std::os::raw::c_char, keyspace_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_set_serial_consistency(
        statement: *mut CassStatement, serial_consistency: CassConsistency
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_set_paging_state_token(
        statement: *mut CassStatement, paging_state: *const ::std::os::raw::c_char, paging_state_size: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_set_is_idempotent(statement: *mut CassStatement, is_idempotent: cass_bool_t) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_set_retry_policy(
        statement: *mut CassStatement, retry_policy: *mut CassRetryPolicy
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_set_custom_payload(
        statement: *mut CassStatement, payload: *const CassCustomPayload
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_null_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_null_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_int8_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_int8_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_int8_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int8_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_int16_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_int16_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_int16_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int16_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_int32_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_int32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_int32_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int32_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_uint32_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_uint32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_uint32_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_uint32_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_int64_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_int64_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_int64_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int64_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_float_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_float_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_float_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_float_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_double_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_double_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_double_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_double_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_bool_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: cass_bool_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_bool_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_bool_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_string(
        statement: *mut CassStatement, index: usize, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_string_n(
        statement: *mut CassStatement, index: usize, value: *const ::std::os::raw::c_char, value_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_string_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_bytes(
        statement: *mut CassStatement, index: usize, value: *const cass_byte_t, value_size: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_bytes_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_custom(
        statement: *mut CassStatement, index: usize, class_name: *const ::std::os::raw::c_char,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_custom_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, class_name: *const ::std::os::raw::c_char,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_custom_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize,
        class_name: *const ::std::os::raw::c_char, class_name_length: usize, value: *const cass_byte_t,
        value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_uuid_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: CassUuid
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_uuid_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: CassUuid
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_inet_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, value: CassInet
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_inet_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, value: CassInet
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_decimal(
        statement: *mut CassStatement, index: usize, varint: *const cass_byte_t, varint_size: usize,
        scale: cass_int32_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_decimal_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, varint: *const cass_byte_t,
...
extern "C" {
    ...
    pub fn cass_statement_bind_duration(
        statement: *mut CassStatement, index: usize, months: cass_int32_t, days: cass_int32_t, nanos: cass_int64_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_duration_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, months: cass_int32_t, days: cass_int32_t,
        nanos: cass_int64_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_duration_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, months: cass_int32_t,
        days: cass_int32_t, nanos: cass_int64_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_collection(
        statement: *mut CassStatement, index: usize, collection: *const CassCollection
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_collection_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, collection: *const CassCollection
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_statement_bind_tuple_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, tuple: *const CassTuple
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_tuple_by_name_n(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, name_length: usize, tuple: *const CassTuple
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_user_type(
        statement: *mut CassStatement, index: usize, user_type: *const CassUserType
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_statement_bind_user_type_by_name(
        statement: *mut CassStatement, name: *const ::std::os::raw::c_char, user_type: *const CassUserType
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_prepared_parameter_name(
        prepared: *const CassPrepared, index: usize, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_prepared_parameter_data_type_by_name(
        prepared: *const CassPrepared, name: *const ::std::os::raw::c_char
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_prepared_parameter_data_type_by_name_n(
        prepared: *const CassPrepared, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassDataType;
}
extern "C" {
...
extern "C" {
    ...
    /// @param[in] keyspace
    /// @return CASS_OK if successful, otherwise an error occurred.
    pub fn cass_batch_set_keyspace(batch: *mut CassBatch, keyspace: *const ::std::os::raw::c_char) -> CassError;
}
extern "C" {
    ...
    pub fn cass_batch_set_keyspace_n(
        batch: *mut CassBatch, keyspace: *const ::std::os::raw::c_char, keyspace_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    ///
    /// @see cass_cluster_set_constant_speculative_execution_policy()
    pub fn cass_batch_set_is_idempotent(batch: *mut CassBatch, is_idempotent: cass_bool_t) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_data_type_type_name(
        data_type: *const CassDataType, type_name: *mut *const ::std::os::raw::c_char, type_name_length: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_type_name(
        data_type: *mut CassDataType, type_name: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_type_name_n(
        data_type: *mut CassDataType, type_name: *const ::std::os::raw::c_char, type_name_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_keyspace(
        data_type: *const CassDataType, keyspace: *mut *const ::std::os::raw::c_char, keyspace_length: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_keyspace(
        data_type: *mut CassDataType, keyspace: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_keyspace_n(
        data_type: *mut CassDataType, keyspace: *const ::std::os::raw::c_char, keyspace_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_class_name(
        data_type: *const CassDataType, class_name: *mut *const ::std::os::raw::c_char, class_name_length: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_class_name(
        data_type: *mut CassDataType, class_name: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_set_class_name_n(
        data_type: *mut CassDataType, class_name: *const ::std::os::raw::c_char, class_name_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_data_type_sub_data_type_by_name(
        data_type: *const CassDataType, name: *const ::std::os::raw::c_char
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_data_type_sub_data_type_by_name_n(
        data_type: *const CassDataType, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassDataType;
}
extern "C" {
    ...
    pub fn cass_data_type_sub_type_name(
        data_type: *const CassDataType, index: usize, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_data_type_add_sub_type_by_name(
        data_type: *mut CassDataType, name: *const ::std::os::raw::c_char, sub_data_type: *const CassDataType
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_data_type_add_sub_type_by_name_n(
        data_type: *mut CassDataType, name: *const ::std::os::raw::c_char, name_length: usize,
...
extern "C" {
    ...
    pub fn cass_data_type_add_sub_value_type_by_name(
        data_type: *mut CassDataType, name: *const ::std::os::raw::c_char, sub_value_type: CassValueType
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_collection_append_string(
        collection: *mut CassCollection, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_string_n(
        collection: *mut CassCollection, value: *const ::std::os::raw::c_char, value_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_bytes(
        collection: *mut CassCollection, value: *const cass_byte_t, value_size: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_custom(
        collection: *mut CassCollection, class_name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: usize,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_custom_n(
        collection: *mut CassCollection, class_name: *const ::std::os::raw::c_char, class_name_length: usize,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_collection_append_decimal(
        collection: *mut CassCollection, varint: *const cass_byte_t, varint_size: usize, scale: cass_int32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_duration(
        collection: *mut CassCollection, months: cass_int32_t, days: cass_int32_t, nanos: cass_int64_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_collection_append_collection(
        collection: *mut CassCollection, value: *const CassCollection
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_tuple_set_string(
        tuple: *mut CassTuple, index: usize, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_tuple_set_string_n(
        tuple: *mut CassTuple, index: usize, value: *const ::std::os::raw::c_char, value_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_tuple_set_bytes(
        tuple: *mut CassTuple, index: usize, value: *const cass_byte_t, value_size: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_tuple_set_custom(
        tuple: *mut CassTuple, index: usize, class_name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: usize,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_tuple_set_custom_n(
        tuple: *mut CassTuple, index: usize, class_name: *const ::std::os::raw::c_char, class_name_length: usize,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_tuple_set_decimal(
        tuple: *mut CassTuple, index: usize, varint: *const cass_byte_t, varint_size: usize, scale: cass_int32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_tuple_set_duration(
        tuple: *mut CassTuple, index: usize, months: cass_int32_t, days: cass_int32_t, nanos: cass_int64_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_null_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_null_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_int8_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_int8_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_int8_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int8_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_int16_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_int16_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_int16_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int16_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_int32_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_int32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_int32_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int32_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_uint32_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_uint32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_uint32_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_uint32_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_int64_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_int64_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_int64_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_int64_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_float_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_float_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_float_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_float_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_double_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_double_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_double_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_double_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_bool_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: cass_bool_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_bool_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: cass_bool_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_string(
        user_type: *mut CassUserType, index: usize, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_string_n(
        user_type: *mut CassUserType, index: usize, value: *const ::std::os::raw::c_char, value_length: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_string_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: *const ::std::os::raw::c_char
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_bytes(
        user_type: *mut CassUserType, index: usize, value: *const cass_byte_t, value_size: usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_bytes_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: *const cass_byte_t, value_size: usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_custom(
        user_type: *mut CassUserType, index: usize, class_name: *const ::std::os::raw::c_char,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_custom_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, class_name: *const ::std::os::raw::c_char,
        value: *const cass_byte_t, value_size: usize,
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_uuid_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: CassUuid
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_uuid_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: CassUuid
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_inet_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: CassInet
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_inet_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: CassInet
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_decimal(
        user_type: *mut CassUserType, index: usize, varint: *const cass_byte_t, varint_size: usize,
...
extern "C" {
    ...
    pub fn cass_user_type_set_decimal_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, varint: *const cass_byte_t,
...
extern "C" {
    ...
    pub fn cass_user_type_set_decimal_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize,
        varint: *const cass_byte_t, varint_size: usize, scale: ::std::os::raw::c_int,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_duration(
        user_type: *mut CassUserType, index: usize, months: cass_int32_t, days: cass_int32_t, nanos: cass_int64_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_duration_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, months: cass_int32_t, days: cass_int32_t,
        nanos: cass_int64_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_duration_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, months: cass_int32_t,
        days: cass_int32_t, nanos: cass_int64_t,
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_collection(
        user_type: *mut CassUserType, index: usize, value: *const CassCollection
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_collection_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: *const CassCollection
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_user_type_set_tuple_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: *const CassTuple
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_tuple_by_name_n(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, name_length: usize, value: *const CassTuple
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_user_type(
        user_type: *mut CassUserType, index: usize, value: *const CassUserType
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_user_type_set_user_type_by_name(
        user_type: *mut CassUserType, name: *const ::std::os::raw::c_char, value: *const CassUserType
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_result_column_name(
        result: *const CassResult, index: usize, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_result_paging_state_token(
        result: *const CassResult, paging_state: *mut *const ::std::os::raw::c_char, paging_state_size: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_error_result_keyspace(
        error_result: *const CassErrorResult, keyspace: *mut *const ::std::os::raw::c_char, keyspace_length: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_error_result_table(
        error_result: *const CassErrorResult, table: *mut *const ::std::os::raw::c_char, table_length: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_error_result_function(
        error_result: *const CassErrorResult, function: *mut *const ::std::os::raw::c_char, function_length: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_error_result_arg_type(
        error_result: *const CassErrorResult, index: usize, arg_type: *mut *const ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn cass_iterator_get_user_type_field_name(
        iterator: *const CassIterator, name: *mut *const ::std::os::raw::c_char, name_length: *mut usize
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_row_get_column_by_name_n(
        row: *const CassRow, name: *const ::std::os::raw::c_char, name_length: usize
    ) -> *const CassValue;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_value_get_string(
        value: *const CassValue, output: *mut *const ::std::os::raw::c_char, output_size: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_value_get_bytes(
        value: *const CassValue, output: *mut *const cass_byte_t, output_size: *mut usize
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_value_get_decimal(
        value: *const CassValue, varint: *mut *const cass_byte_t, varint_size: *mut usize, scale: *mut cass_int32_t
    ) -> CassError;
}
extern "C" {
    ...
    pub fn cass_value_get_duration(
        value: *const CassValue, months: *mut cass_int32_t, days: *mut cass_int32_t, nanos: *mut cass_int64_t
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_uuid_from_string_n(
        str: *const ::std::os::raw::c_char, str_length: usize, output: *mut CassUuid
    ) -> CassError;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_timestamp_gen_monotonic_new_with_settings(
        warning_threshold_us: cass_int64_t, warning_interval_ms: cass_int64_t
...
extern "C" {
    ...
    pub fn cass_custom_payload_set(
        payload: *mut CassCustomPayload, name: *const ::std::os::raw::c_char, value: *const cass_byte_t,
        value_size: usize,
    );
}
extern "C" {
    ...
    pub fn cass_custom_payload_set_n(
        payload: *mut CassCustomPayload, name: *const ::std::os::raw::c_char, name_length: usize,
        value: *const cass_byte_t, value_size: usize,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_inet_from_string_n(
        str: *const ::std::os::raw::c_char, str_length: usize, output: *mut CassInet
    ) -> CassError;
}
extern "C" {
