...
extern "C" {
    ...
    pub fn cass_table_meta_index_count(table_meta: *const CassTableMeta) -> size_t;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cass_table_meta_materialized_view_count(table_meta: *const CassTableMeta) -> size_t;
}
extern "C" {
