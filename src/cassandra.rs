...
#[repr(u32)]
pub enum Enum_Unnamed1 { cass_false = 0, cass_true = 1, }
...
impl ::std::clone::Clone for Struct_CassVersion_ {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for Struct_CassVersion_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
pub enum Struct_CassMaterializedViewMeta_ { }
...
pub enum Struct_CassIndexMeta_ { }
...
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_CassClusteringOrder_ {
    CASS_CLUSTERING_ORDER_NONE = 0,
    CASS_CLUSTERING_ORDER_ASC = 1,
    CASS_CLUSTERING_ORDER_DESC = 2,
}
pub type CassClusteringOrder = Enum_CassClusteringOrder_;
#[derive(Clone, Copy)]
#[repr(u32)]
