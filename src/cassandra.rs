...
extern "C" {
    ...
    pub fn cass_error_result_arg_type(error_result: *const CassErrorResult,
                                      index: size_t,
                                      arg_type: *mut *const ::libc::c_char,
